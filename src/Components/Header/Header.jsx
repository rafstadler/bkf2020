    ...
    render() {
        return (
                ...
                <Row>
                    ...
                    <Col onClick={() => this.props.callbackpage("EXHIBITION")} className="header-categorie d-none d-sm-none d-md-block">EXHIBITIONS</Col>
                    ...
                    <Col className="header-drop d-md-none d-sm-block">
                        <NavDropdown title={this.props.page} id="nav-dropdown">
                            ...
                            <NavDropdown.Item onClick={() => this.props.callbackpage("EXHIBITION")}>EXHIBITIONS</NavDropdown.Item>
